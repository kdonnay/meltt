...
```
The package requires that users have Python (>= 2.7) installed on their computer. To quickly get Pythong, install an [Anaconda](https://www.continuum.io/downloads) platform. `meltt` will use the program in the background.
